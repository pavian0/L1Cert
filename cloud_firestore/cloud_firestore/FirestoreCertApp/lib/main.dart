...
extension on Query<Movie> {
  ...
  Query<Movie> queryBy(MovieQuery query) {
    switch (query) {
      ...
      case MovieQuery.drama:
        return where('genre', arrayContainsAny: ['drama']);
    ...
    return Scaffold(
      appBar: AppBar(
        title: Column(
          ...
          children: [
            const Text('Firestore Movies DB'),
          ...
          PopupMenuButton<MovieQuery>(
            ...
            itemBuilder: (BuildContext context) {
              return [
                ...
                const PopupMenuItem(
                  value: MovieQuery.drama,
                  child: Text('Filter genre Drama'),
                ),
              ];
            },
          ),
